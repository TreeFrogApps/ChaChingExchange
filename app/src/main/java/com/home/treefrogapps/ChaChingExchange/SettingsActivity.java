...
public class SettingsActivity extends ActionBarActivity {
    ...
    public void settingsPopulatedListData() {
        ...
        settingsCountryCode = new String[]{
                ...
                "HUF", "IDR", "ILS", "INR", "JPY", "KRW", "MXN", "NOK", "NZD", "PHP", "PLN",
        ...
        settingsCountry = new String[]{
                ...
                "Philippine Peso", "Polish NEW Zloty", "Romanian Leu", "Russian Rouble",
                "Swedish Krona", "Singapore Dollar", "Thai Baht", "New Turkish Lira",
                "Taiwan Dollar", "United States Dollar", "South African Rand"
        };
